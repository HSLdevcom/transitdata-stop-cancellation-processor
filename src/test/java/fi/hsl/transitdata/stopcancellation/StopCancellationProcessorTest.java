...
public class StopCancellationProcessorTest {
    ...
    public void setup() {
        ...
        InternalMessages.JourneyPattern journeyPattern1 = InternalMessages.JourneyPattern.newBuilder()
                ...
                .addTrips(InternalMessages.TripInfo.newBuilder().setTripId("1").setRouteId("1001")
                        .setOperatingDay("20200101").setStartTime("12:00:00").setDirectionId(1).build())
                .addTrips(InternalMessages.TripInfo.newBuilder().setTripId("1").setRouteId("1001")
                        .setOperatingDay("20200101").setStartTime("14:00:00").setDirectionId(1).build())
                .build();
        ...
        InternalMessages.JourneyPattern journeyPattern2 = InternalMessages.JourneyPattern.newBuilder()
                ...
                .addTrips(InternalMessages.TripInfo.newBuilder().setTripId("2").setRouteId("1001")
                        .setOperatingDay("20200101").setStartTime("12:00:00").setDirectionId(2).build())
                .build();

        InternalMessages.StopCancellations stopCancellations = InternalMessages.StopCancellations.newBuilder()
                .addAffectedJourneyPatterns(journeyPattern1).addAffectedJourneyPatterns(journeyPattern2)
                .addStopCancellations(InternalMessages.StopCancellations.StopCancellation.newBuilder()
                        .setCause(InternalMessages.StopCancellations.Cause.CLOSED_STOP).setStopId("1")
                        ...
                        .addAffectedJourneyPatternIds("1").addAffectedJourneyPatternIds("2"))
                /*.addStopCancellations(InternalMessages.StopCancellations.StopCancellation.newBuilder()
                        .setStopId("1")
    ...
    public void testScheduleRelationshipIsNotChangedForStopThatIsNotCancelled() {
        GtfsRealtime.TripUpdate tripUpdate = GtfsRealtime.TripUpdate.newBuilder()
                .setTrip(GtfsRealtime.TripDescriptor.newBuilder().setRouteId("1001").setStartDate("20200101")
                        .setStartTime("12:00:00").setDirectionId(0).build())
                .addStopTimeUpdate(GtfsRealtime.TripUpdate.StopTimeUpdate.newBuilder().setStopId("1")
                        ...
                        .build())
                .addStopTimeUpdate(GtfsRealtime.TripUpdate.StopTimeUpdate.newBuilder().setStopId("2")
                        ...
                        .setScheduleRelationship(GtfsRealtime.TripUpdate.StopTimeUpdate.ScheduleRelationship.SCHEDULED)
                        .build())
                .addStopTimeUpdate(GtfsRealtime.TripUpdate.StopTimeUpdate.newBuilder().setStopId("3")
        ...
        GtfsRealtime.TripUpdate tripUpdateWithStopCancellations = stopCancellationProcessor
                .applyStopCancellations(tripUpdate);
        Optional<GtfsRealtime.TripUpdate.StopTimeUpdate> stop3 = tripUpdateWithStopCancellations.getStopTimeUpdateList()
                .stream().filter(stu -> "3".equals(stu.getStopId())).findAny();
        ...
        assertEquals(GtfsRealtime.TripUpdate.StopTimeUpdate.ScheduleRelationship.SCHEDULED,
                stop3.get().getScheduleRelationship());
    }
    ...
    public void testScheduleRelationshipIsNotChangedWhenStopCancellationIsNotValid() {
        GtfsRealtime.TripUpdate tripUpdate = GtfsRealtime.TripUpdate.newBuilder()
                .setTrip(GtfsRealtime.TripDescriptor.newBuilder().setRouteId("1001").setStartDate("20200101")
                        .setStartTime("14:00:00").setDirectionId(0).build())
                .addStopTimeUpdate(GtfsRealtime.TripUpdate.StopTimeUpdate.newBuilder().setStopId("1")
                        .setArrival(GtfsRealtime.TripUpdate.StopTimeEvent.newBuilder().setDelay(0).build())
                        .setDeparture(GtfsRealtime.TripUpdate.StopTimeEvent.newBuilder().setDelay(10).build())
                        .setScheduleRelationship(GtfsRealtime.TripUpdate.StopTimeUpdate.ScheduleRelationship.SCHEDULED)
        ...
        GtfsRealtime.TripUpdate tripUpdateWithStopCancellations = stopCancellationProcessor
                .applyStopCancellations(tripUpdate);
        Optional<GtfsRealtime.TripUpdate.StopTimeUpdate> stop1 = tripUpdateWithStopCancellations.getStopTimeUpdateList()
                .stream().filter(stu -> "1".equals(stu.getStopId())).findAny();

        assertTrue(stop1.isPresent());
        assertEquals("1", stop1.get().getStopId());
        assertEquals(GtfsRealtime.TripUpdate.StopTimeUpdate.ScheduleRelationship.SCHEDULED,
                stop1.get().getScheduleRelationship());
    }
    ...
    public void testScheduleRelationshipIsChangedForStopIsCancelled() {
        ...
        assertTrue(stop1.isPresent());
        assertEquals("1", stop1.get().getStopId());
        assertEquals(GtfsRealtime.TripUpdate.StopTimeUpdate.ScheduleRelationship.SKIPPED,
                stop1.get().getScheduleRelationship());
    }
    ...
    public void testCancellationOfCancellation() {
        ...
        GtfsRealtime.TripUpdate tripUpdateAfterCancellationOfCancellation = stopCancellationProcessor
                .applyStopCancellations(tripUpdate);
        assertEquals(3, tripUpdateAfterCancellationOfCancellation.getStopTimeUpdateList().stream()
                .filter(stopTimeUpdate -> stopTimeUpdate
                        .getScheduleRelationship() != GtfsRealtime.TripUpdate.StopTimeUpdate.ScheduleRelationship.SKIPPED)
                .count());
    }
    ...
    public void testNoDataTripUpdatesAreCreated() {
        ...
        Optional<GtfsRealtime.TripUpdate> maybeTrip1 = tripUpdates.stream()
                ...
                .map(tripUpdateWithId -> tripUpdateWithId.tripUpdate).findAny();
        ...
        assertEquals(GtfsRealtime.TripUpdate.StopTimeUpdate.ScheduleRelationship.SKIPPED,
                trip1.getStopTimeUpdate(0).getScheduleRelationship());
        ...
        assertEquals(GtfsRealtime.TripUpdate.StopTimeUpdate.ScheduleRelationship.NO_DATA,
                trip1.getStopTimeUpdate(1).getScheduleRelationship());
        assertEquals("3", trip1.getStopTimeUpdate(2).getStopId());
        assertEquals(GtfsRealtime.TripUpdate.StopTimeUpdate.ScheduleRelationship.NO_DATA,
                trip1.getStopTimeUpdate(2).getScheduleRelationship());
    }
    ...
    public void testNoDataTripUpdatesAreCancelledAfterStopCancellation() {
        ...
        Collection<TripUpdateWithId> tripUpdatesWithCancellationsOfCancellations = stopCancellationProcessor
                .getStopCancellationTripUpdates(timestamp + 1);

        assertEquals(2, tripUpdatesWithCancellationsOfCancellations.size());
        assertEquals(2, tripUpdatesWithCancellationsOfCancellations.stream().filter(tripUpdateWithId -> {
            GtfsRealtime.TripUpdate tripUpdate = tripUpdateWithId.tripUpdate;

            return tripUpdate.getStopTimeUpdateCount() == 1 && tripUpdate.getStopTimeUpdate(0)
                    .getScheduleRelationship() != GtfsRealtime.TripUpdate.StopTimeUpdate.ScheduleRelationship.SKIPPED;
        }).count());
    }
