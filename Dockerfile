...
COPY --from=BUILD /usr/src/app/target/transitdata-stop-cancellation-processor-jar-with-dependencies.jar /usr/app/transitdata-stop-cancellation-processor.jar

ENTRYPOINT ["java", "-jar", "/usr/app/transitdata-stop-cancellation-processor.jar"]
